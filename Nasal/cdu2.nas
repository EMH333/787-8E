...
setprop("/controls/cdu[1]/display/l1", "Boeing 787-E");
setprop("/controls/cdu[1]/display/l2", "");
setprop("/controls/cdu[1]/display/l3", "");
setprop("/controls/cdu[1]/display/l4", "");
setprop("/controls/cdu[1]/display/l5", "");
...
setprop("/controls/cdu[1]/display/r1", "RR Trent_1000");
...
setprop("/controls/cdu[1]/route-manager/max-pages", i + 1);
}
}
...
var lastpagewps = getprop("/autopilot/route-manager/route/num") - ((getprop("/controls/cdu[1]/route-manager/max-pages") - 1) * 4);

if (lastpagewps >= 1) {
l1_wp = ((getprop("/controls/cdu[1]/route-manager/max-pages") - 1) * 4);
if (currentwp == l1_wp) {
...
if (lastpagewps >= 2) {
l2_wp = ((getprop("/controls/cdu[1]/route-manager/max-pages") - 1) * 4) + 1;
if (currentwp == l2_wp) {
...
if (lastpagewps >= 3) {
l3_wp = ((getprop("/controls/cdu[1]/route-manager/max-pages") - 1) * 4) + 2;
if (currentwp == l3_wp) {
...
if (lastpagewps == 4) {
l4_wp = ((getprop("/controls/cdu[1]/route-manager/max-pages") - 1) * 4) + 3;
if (currentwp == l4_wp) {
...
l1_wp = ((getprop("/controls/cdu[1]/route-manager/page") - 1) * 4);
l2_wp = ((getprop("/controls/cdu[1]/route-manager/page") - 1) * 4) + 1;
l3_wp = ((getprop("/controls/cdu[1]/route-manager/page") - 1) * 4) + 2;
l4_wp = ((getprop("/controls/cdu[1]/route-manager/page") - 1) * 4) + 3;	
...
if (keypress == "r6") {
# setprop("/controls/cdu[1]/input", "REMOVE");
cduinput = "REMOVE";
keypress = "";
}
...
setprop("/controls/cdu[1]/display/r1", getprop("/instrumentation/fmc/vspeeds/V1"));

setprop("/controls/cdu[1]/display/l2", "Min. 1800 FPM");
setprop("/controls/cdu[1]/display/r2", getprop("/instrumentation/fmc/vspeeds/VR"));

setprop("/controls/cdu[1]/display/l3", "12 Degrees");
setprop("/controls/cdu[1]/display/r3", getprop("/instrumentation/fmc/vspeeds/V2"));

fmc.calc_speeds();

setprop("/controls/cdu[1]/display/l4", getprop("/instrumentation/b787-fmc/speeds/flaps10"));
setprop("/controls/cdu[1]/display/r4", "");

setprop("/controls/cdu[1]/display/l5", getprop("/instrumentation/b787-fmc/speeds/flaps5"));
setprop("/controls/cdu[1]/display/r5", "");

setprop("/controls/cdu[1]/display/l6", getprop("/instrumentation/b787-fmc/speeds/flaps1"));
setprop("/controls/cdu[1]/display/r6", "");
...
setprop("/controls/cdu[1]/display/l1", getprop("/instrumentation/b787-fmc/speeds/flaps1"));
setprop("/controls/cdu[1]/display/r1", "-2500 FPM");

setprop("/controls/cdu[1]/display/l2", getprop("/instrumentation/b787-fmc/speeds/flaps5"));
setprop("/controls/cdu[1]/display/r2", "");

setprop("/controls/cdu[1]/display/l3", getprop("/instrumentation/b787-fmc/speeds/flaps10"));
setprop("/controls/cdu[1]/display/r3", getprop("/instrumentation/b787-fmc/speeds/ap"));

setprop("/controls/cdu[1]/display/l4", getprop("/instrumentation/b787-fmc/speeds/flaps15"));
setprop("/controls/cdu[1]/display/r4", getprop("/instrumentation/b787-fmc/speeds/td"));

setprop("/controls/cdu[1]/display/l5", getprop("/instrumentation/b787-fmc/speeds/flaps25"));
setprop("/controls/cdu[1]/display/r5", "");

setprop("/controls/cdu[1]/display/l6", getprop("/instrumentation/b787-fmc/speeds/flaps35"));
setprop("/controls/cdu[1]/display/r6", "");
...
setprop("/controls/cdu[1]/display/r4", getprop("/controls/fbw/bank-limit"));
...
if (me.nochart == 1) setprop("/controls/cdu[1]/display/l4", "No Available Charts");
else setprop("/controls/cdu[1]/display/l4", getprop("/instrumentation/efb/chart/selected"));
...
setprop("/controls/cdu[1]/display/l1-label", "");
setprop("/controls/cdu[1]/display/l2-label", "Cruise Altitude");
setprop("/controls/cdu[1]/display/l3-label", "Start Cruise at");
...
setprop("/controls/cdu[1]/display/l2", getprop("/controls/cdu/vnav/crz-altitude-ft"));
setprop("/controls/cdu[1]/display/r2", "");

setprop("/controls/cdu[1]/display/l3", getprop("/controls/cdu/vnav/start-crz"));
setprop("/controls/cdu[1]/display/r3", "");

setprop("/controls/cdu[1]/display/l4", getprop("/controls/cdu/vnav/end-crz"));
setprop("/controls/cdu[1]/display/r4", "");
...
if (getprop("/instrumentation/fmcHelp[1]/search/active") != 1)	
	...
	setprop("/instrumentation/fmcHelp[1]/search/input",substr(getprop("/instrumentation/fmcHelp[1]/search/input"),0,fmc_charlength - 1));
}
...
if (getprop("/instrumentation/fmcHelp[1]/search/active") != 1)
	...
	setprop("/instrumentation/fmcHelp[1]/search/input", getprop("/instrumentation/fmcHelp[1]/search/input") ~ keypress);
